...
const primerDigitoPasaporte = prompt('Ingrese el primer dígito del número del pasaporte');

//Verificar información

const esNacional = primerDigitoPasaporte ===' A';

console.log(`El turista ${esNacional ? 'es' : 'no es'} nacional.`)